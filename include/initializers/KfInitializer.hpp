/**
 * @file KfInitializer.hpp
 * @brief Kalman filter system initializer
 *
 * Provides functionality to initialize KF-based navigation systems.
 *
 * @author peanut-nav
...
class KfInitializer : public ISystemInitializer {
public:
    KfInitializer(int IMUrate, int GPSrate, int simTime);
